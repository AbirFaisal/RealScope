...
public class TitlePane extends JPanel implements Localizable, ITitleStatus,
	...
	public boolean switchRS() {
		if (run) {
			...
			// When the recording ends, loadPos0 is returned to the RT state.
			if (dh.isParaAsync())
...
//		btnRS.setIcon(si);
		...
		final LButton btnClose = new LButton("Close");
