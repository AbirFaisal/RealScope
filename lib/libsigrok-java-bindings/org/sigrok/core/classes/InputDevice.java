...
public class InputDevice extends Device {
  ...
  protected InputDevice(long cPtr, boolean cMemoryOwn) {
    super(classesJNI.InputDevice_SWIGSmartPtrUpcast(cPtr), true);
    swigCMemOwnDerived = cMemoryOwn;
    swigCPtr = cPtr;
  }

  protected static long getCPtr(InputDevice obj) {
  ...
  public synchronized void delete() {
    if (swigCPtr != 0) {
      if (swigCMemOwnDerived) {
        ...
        classesJNI.delete_InputDevice(swigCPtr);
      }
      swigCPtr = 0;
    }
    super.delete();
